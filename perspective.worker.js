...
/***/ "../perspective/packages/perspective/dist/esm/config/index.js":
/*!********************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/config/index.js ***!
  \********************************************************************/
 ...
 *
 */
const DEFAULT_CONFIG = __webpack_require__(/*! ./settings.js */ "../perspective/packages/perspective/dist/esm/config/settings.js").default;
...
/***/ "../perspective/node_modules/detectie/detectie.js":
/*!********************************************************!*\
  !*** ../perspective/node_modules/detectie/detectie.js ***!
  \********************************************************/
/***/ ((module) => {
...
/***/ "../perspective/packages/perspective/dist/esm/@finos/perspective-cpp/dist/esm/perspective.cpp.js":
/*!*******************************************************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/@finos/perspective-cpp/dist/esm/perspective.cpp.js ***!
  \*******************************************************************************************************/
...
/***/ "../perspective/packages/perspective/dist/esm/api/server.js":
/*!******************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/api/server.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ "../perspective/packages/perspective/dist/esm/config/index.js");
/******************************************************************************
 *
...
/***/ "../perspective/packages/perspective/dist/esm/config/constants.js":
/*!************************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/config/constants.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const NUMBER_AGGREGATES = ["any", "avg", "abs sum", "count", "distinct count", "dominant", "first by index", "last by index", "last", "high", "low", "mean", "median", "pct sum parent", "pct sum grand total", "sum", "sum abs", "sum not null", "unique"];
...
/***/ "../perspective/packages/perspective/dist/esm/config/settings.js":
/*!***********************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/config/settings.js ***!
  \***********************************************************************/
/***/ ((module) => {
...
/***/ "../perspective/packages/perspective/dist/esm/data_accessor/index.js":
/*!***************************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/data_accessor/index.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils.js */ "../perspective/packages/perspective/dist/esm/utils.js");
/* harmony import */ var _config_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../config/index.js */ "../perspective/packages/perspective/dist/esm/config/index.js");
/******************************************************************************
 *
...
/***/ "../perspective/packages/perspective/dist/esm/emscripten.js":
/*!******************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/emscripten.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _config_constants_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config/constants.js */ "../perspective/packages/perspective/dist/esm/config/constants.js");
/* harmony import */ var _config_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config/index.js */ "../perspective/packages/perspective/dist/esm/config/index.js");
/* harmony import */ var _data_accessor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data_accessor */ "../perspective/packages/perspective/dist/esm/data_accessor/index.js");
/* harmony import */ var _emscripten_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emscripten.js */ "../perspective/packages/perspective/dist/esm/emscripten.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils.js */ "../perspective/packages/perspective/dist/esm/utils.js");
/* harmony import */ var _api_server_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./api/server.js */ "../perspective/packages/perspective/dist/esm/api/server.js");
/* harmony import */ var _view_formatters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view_formatters */ "../perspective/packages/perspective/dist/esm/view_formatters.js");
/******************************************************************************
 *
 * Copyright (c) 2017, the Perspective Authors.
 *
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(Module) {
  ...
  function view(table, sides, config, view_config, name) {
    ...
    this.is_unit_context = this.table.index === "" && sides === 0 && this.view_config.row_pivots.length === 0 && this.view_config.column_pivots.length === 0 && this.view_config.filter.length === 0 && this.view_config.sort.length === 0 && this.view_config.computed_columns.length === 0;
  ...
  view.prototype.computed_schema = function (override = true) {
    const schema = (0,_emscripten_js__WEBPACK_IMPORTED_MODULE_3__.extract_map)(this._View.computed_schema());
  ...
  table.prototype.computed_schema = function (computed_columns, override = true) {
    ...
    for (let key = 0; key < columns.size(); key++) {
      ...
      if (override && this.overridden_types[name]) {
        ...
        new_schema[name] = (0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.get_column_type)(type.value);
      }
    }
  ...
  table.prototype.get_computation_input_types = function (computed_function_name) {
    ...
    for (let i = 0; i < types.size(); i++) {
      ...
      new_types.push((0,_utils_js__WEBPACK_IMPORTED_MODULE_4__.get_column_type)(type.value));
    }
  ...
  table.prototype.get_computed_functions = function () {
    let functions = (0,_emscripten_js__WEBPACK_IMPORTED_MODULE_3__.extract_map)(__MODULE__.get_computed_functions());

    for (const f in functions) {
      if (functions.hasOwnProperty(f)) {
        // Extract inner map
        functions[f] = (0,_emscripten_js__WEBPACK_IMPORTED_MODULE_3__.extract_map)(functions[f]);
...
/***/ "../perspective/packages/perspective/dist/esm/utils.js":
/*!*************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/utils.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const detectIE = __webpack_require__(/*! detectie */ "../perspective/node_modules/detectie/detectie.js");
/**
 * Detect Chrome.
 *
 * Returns
...
/***/ "../perspective/packages/perspective/dist/esm/view_formatters.js":
/*!***********************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/view_formatters.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!**************************************************************************!*\
  !*** ../perspective/packages/perspective/dist/esm/perspective.worker.js ***!
  \**************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _finos_perspective_cpp__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./@finos/perspective-cpp */ "../perspective/packages/perspective/dist/esm/@finos/perspective-cpp/dist/esm/perspective.cpp.js");
/* harmony import */ var _perspective_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./perspective.js */ "../perspective/packages/perspective/dist/esm/perspective.js");
/******************************************************************************
 *
 * Copyright (c) 2017, the Perspective Authors.
 *
